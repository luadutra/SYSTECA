...
<div align="center">
	<form class="form-inline md-form mr-auto mb-4" action="historico_alu.php" method="post">
...
<button style="font-size:12px" type="button" class="btn btn-success btn-sm" onClick="window.location='lista_his_alu.php?aux=<?php echo $rows_busca['alu_cod'];?>';">SELECIONAR</button>
    </div></td>
    </tr>
