...
<form method="post" action="grava_ret.php">
    ...
    <div class="form-group col-md-6" align="center">
     ...
     <td>
     	<select class="meuselect" name="aluno" required>
			...
			?>
            	<option value="<?php echo $rows_busca['alu_cod']; ?>"> <?php echo $rows_busca['nome']; ?> </option>
            <?php } ?>
        </select>
     </td>  
    </div>
     ...
     <td>
     	<select class="meuselect" name="livro" required>
        	...
        	<?php
				...
				while($rows_busca = mysqli_fetch_assoc($resultado)) {
			?>
            	<option value="<?php echo $rows_busca['codigo_liv']; ?>"> <?php echo $rows_busca['nome']; ?> </option>
            <?php } ?>
        </select>
     </td>  
    </div>
...
<div align="center">
<button type="submit" class="btn btn-primary" name="botao">FINALIZAR</button>
<hr>                  
