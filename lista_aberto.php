...
if(isset($_POST['buscar'])) {
    ...
    $busca = "SELECT * FROM aberto WHERE CONCAT(codigo_liv, livro, serie, aluno, data_br) LIKE '%".$valorBusca."%' ORDER BY data_ret, aluno, livro ASC";
    $buscar_resultado = filterTable($conexao, $busca);
    
} else {
    $busca = "SELECT * FROM aberto ORDER BY data_ret, aluno, livro ASC";
...
<div align="center"> <p><img src="imagem.jpg" width="401" height="148"></p> </div>
  ...
  <hr>
<div align="center">
	<form class="form-inline md-form mr-auto mb-4" action="lista_aberto.php" method="post">
...
<?php 
	...
	?>
      ...
      <td style="font-size:14px"><div align="center"><?php echo $rows_busca['data_br']; ?></div></td>
    </tr>
