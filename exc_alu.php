...
<hr><hr>
<div align="center" class="alert alert-danger" role="alert"> <h4>TEM CERTEZA QUE DESEJA EXCLUIR ESTE ALUNO ?<h4> </div>

<hr><hr><br>
<div align="center">
<button type="button" class="btn btn-danger" onClick="window.location='lista_alu.php?aux=<?php echo $passada;?>';">C A N C E L A R</button>
<button type="button" class="btn btn-link"></button>
<button type="button" class="btn btn-link"></button>
<button type="button" class="btn btn-success"  onClick="window.location='drop_alu.php?aux=<?php echo $passada;?>';">C O N F I R M A R</button>
</div>
<br>
<hr><hr>
</div>
