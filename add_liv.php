...
<form method="post" action="grava_liv.php">
...
<div class="form-row">   
    ...
    <input autocomplete="off" style="text-align:center" name="codigo" type="text" class="form-control" id="fone_alu" placeholder="Insira o Código do Livro" autofocus required>
    </div>
    
    <div class="form-group col-md-8">
    <div align="center"><label for="inputFone"><b>GÊNERO</b></label></div>
    <input autocomplete="off" style="text-align:center" name="genero" type="text" class="form-control" id="fone_alu" placeholder="Insira o Gênero do Livro">
    </div>
</div>
</div>
...
<div class="form-group">
    ...
    <input autocomplete="off" style="text-align:center" name="nome" type="text" class="form-control" id="nome_alu" placeholder="Insira o Nome do Livro" required>
</div>
