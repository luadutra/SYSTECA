...
$texto = filter_input(INPUT_POST, 'nome', FILTER_SANITIZE_STRING);

$gravando = "INSERT INTO serie (nome) VALUES ('$nome')";
...
if(mysqli_insert_id($conexao)) { ?>
    ...
    <div align="center">
    <button type="button" class="btn btn-primary btn-lg btn-block" onClick="window.location='add_ser.php';">CADASTRAR NOVA SÉRIE</button>
    <hr>
    <button type="button" class="btn btn-primary btn-lg btn-block" onClick="window.location='lista_ser.php';">LISTAR SÉRIES</button>
    <hr>
