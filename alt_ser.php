...
<?php
	...
	$busca = "SELECT * FROM serie WHERE serie_cod = '$passada'";
...
<form method="post" action="grava_alt_ser.php?aux=<?php echo $passada;?>">
   
<div class="form-group">
<div align="center"><label for="nome"><b>NOME</b></label></div>
<input autocomplete="off" style="text-align:center" name="nome" type="text" class="form-control" id="nome" value="<?php echo $nome; ?>" required>
</div>
