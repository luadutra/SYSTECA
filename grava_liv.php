...
$gravando = "INSERT INTO livro (nome, codigo_liv, situacao, retiradas, genero) VALUES ('$nome', '$codigo', '$situacao', '$zero', '$genero')";
...
if(mysqli_insert_id($conexao)) {
	...
	$cont = $rows_busca['cont_liv'];
	$cont = $cont + 1;

$query6 = mysqli_query($conexao, "UPDATE cont SET cont_liv = '$cont';");
...
<div align="center">
<button type="button" class="btn btn-primary btn-lg btn-block" onClick="window.location='add_liv.php';">CADASTRAR OUTRO LIVRO</button>
<hr>
...
<div align="center">
<button type="button" class="btn btn-primary btn-lg btn-block" onClick="window.location='add_liv.php';">TENTAR NOVAMENTE</button>
<hr>
<button type="button" class="btn btn-primary btn-lg btn-block" onClick="window.location='lista_liv.php';">LISTAR LIVROS</button>
<hr>
<button type="button" class="btn btn-primary btn-sm" onClick="window.location='menu.php';">VOLTAR AO MENU PRINCIPAL</button>
