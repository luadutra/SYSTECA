...
<form method="post" action="grava_alu.php">
    
  	<div class="form-group">
        <div align="center"><label for="nome"><b>NOME DO ALUNO</b></label></div>
    <input autocomplete="off" style="text-align:center" name="nome" type="text" class="form-control" id="nome_alu" placeholder="Insira o Nome do Aluno" required>
 	 </div>
